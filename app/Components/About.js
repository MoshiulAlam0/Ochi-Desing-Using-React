...
const About = () => {
  return (
    <section  className="w-full h-auto py-[10vmin]  bg-[#ceeb67]">
      ...
      <div id="about-con" className=" text-content py-[10vmin] px-[8vmin] flex justify-between items-center flex-wrap">
        <p id='about-text-top' className=''>What you can expect:</p>
        <div id='about-info' className=" w-full flex justify-end flex-wrap gap-[20vmin]">
          <div id='para' className=" w-[30vmin] flex flex-col gap-[5vmin]">
          ...
          <div id='contuct' className="self-end flex flex-col mr-[15vmin]">
