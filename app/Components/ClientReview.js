...
const ClientReview = () => {
  return (
    <section className='text-white w-full h-screen py-[5vmin]'>
        <h1 className='px-[7vmin]  text-[5vmin] text-zinc-100 font-semibold pb-[5vmin] border-b-[1px] border-[#ffffff13] '>Clients’ reviews :</h1>
        <div className=" flex flex-wrap items-start justify-between main py-[3vmin] px-[7vmin]">
            <div className='text-[2.8vmin]'><UnderLineText text="Karman Ventures" color="bg-white"/></div>
            <div className="flex flex-col gap-[1vmin] items-start">
                <p className='pb-[6vmin] text-[2.8vmin]'>Services: </p>
                <ArrowButton text="investor deck"/>
                <ArrowButton text="salec deck"/>
                <ArrowButton text="Project ratting"/>
            </div>
            <div className="w-[38%] mr-[15vmin] flex flex-col">
                <p className='pb-[6vmin] text-[2.8vmin]' >William Barnes</p>
                <div className="flex flex-col gap-[3vmin]">
                    <img className='w-[16vmin] rounded-xl' src="https://ochi.design/wp-content/uploads/2023/02/William-Barnes-1-300x300.png" alt="" />
